...
class CreateRefProgressStatusesTable extends Migration
{
    public function up()
    {
        Schema::create('mabaryuk_ref_progress_statuses', function($table)
        {
            $table->engine = 'InnoDB';
            $table->increments('id');
    ...
    {
        Schema::drop('mabaryuk_ref_progress_statuses');
    }
}