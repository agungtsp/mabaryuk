...
/**
 * CreateBillingStatusesTable Migration
 */
class CreateBillingStatusesTable extends Migration
{
    public function up()
    {
        Schema::create('mabaryuk_ref_billing_statuses', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('mabaryuk_ref_billing_statuses');
    }
}
