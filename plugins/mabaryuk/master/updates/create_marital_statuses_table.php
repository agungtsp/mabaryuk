...
/**
 * CreateMaritalStatusesTable Migration
 */
class CreateMaritalStatusesTable extends Migration
{
    public function up()
    {
        Schema::create('mabaryuk_ref_marital_statuses', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('mabaryuk_ref_marital_statuses');
    }
}
